...
This module implements the feed data structures and the encryption workflow
of the Mycelium protocol.

## Overview

The protocol layer defines two plaintext classes (stored unencrypted), with
fields mirroring the Protocol Buffer messages (see details at the bottom):
